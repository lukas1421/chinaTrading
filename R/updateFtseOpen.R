...
updateTradeDateFTSEOpen <- function() {
  ...
  d <- XLConnect::readWorksheet(wb, sheet="2823",startRow = 400, endRow = 1000 , startCol = 1, endCol = 1)
  open <- readWorksheet(wb, sheet="2823",startRow = 400, endRow = 1000 , startCol = 10, endCol = 10)
  names(d) <-c("D")
  names(open) <- c("open")
